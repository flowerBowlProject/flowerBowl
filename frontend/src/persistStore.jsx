...
export const ShowDuplication = (name) => ({
  type: SHOWDUPLICATIONBOOLEAN,
  payload: name,
});
export const HIDEDUPLICATIONBOOLEAN = "HIDE/DUPLICATIONBOOLEAN";
export const HideDuplication = (name) => ({
  type: HIDEDUPLICATIONBOOLEAN,
  payload: name,
});
...
export const closeEmailCheck = () => ({
  type: CLOSEEMAILCHECK,
  payload: false,
});
...
export const setMermberEmail = (email) => ({
  type: SETMEMBEREMAIL,
  payload: email,
});
...
export const setMemberNewPw = (newPw) => ({
  type: SETMEMBERNEWPW,
  payload: newPw,
});
