      ...
      >
        <Grid container direction="column" mt="2vw">
          {name_1 ? (
            <InputMember
              name={name_1}
              helpertext={helpertext_1}
              vaildTest={vaildTest_1}
              setBut={setButDisable}
              setUser={handleSetUser}
            />
          ) : (
            <Grid item height="3.5vw" />
          )}
          <InputMember
            type_pass={type_pass}
            name={name_2}
            helpertext={helpertext_2}
            vaildTest={vaildTest_2}
            setBut={setButDisable_2}
            setUser={handleSetUser}
          />
          {name_1 ? null : <Grid item height="3.5vw" />}
          <Grid item textAlign="center">
            <Button_contain_style
              disabled={name_1 ? butDisable || butDisable_2 : butDisable_2}
              width="15vw"
              sx={{ mb: "2vw" }}
              onClick={() =>
                tag === "login"
