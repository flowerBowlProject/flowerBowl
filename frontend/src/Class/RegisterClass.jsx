...
const RegisterClass = () => {
    ...
    const [registerData, setRegisterData] = useState({
        ...
        lesson_address: '', lesson_contents: '', lesson_longitude: 0.0, lesson_latitude: 0.0, lesson_start: '', lesson_end: '', lesson_URL:''
    });
    ...
    return (
        ...
        onChange={(newValue) => setRegisterData((registerData) => ({ ...registerData, lesson_URL: newValue }))}/>
            </div>
