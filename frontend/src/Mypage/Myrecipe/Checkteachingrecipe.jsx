...
import "./Checkteachingrecipe.css";

const Checkteachingrecipe = () => {
  // 정렬기능
  ...
  return (
    <>
      ...
      <section className="buttons">
        <Inputbutton text="수강레시피 조회" i={true} w="medium" />
        <Inputbutton text="창작레시피 조회" i={false} w="medium" />
      </section>
...
export default Checkteachingrecipe;
