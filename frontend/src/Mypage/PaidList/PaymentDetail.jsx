    ...
    return(
        ...
        <Grid item xs={0.9} ml='6vw'>
            <Link to="/mypage/paymentDetail/checkPaidList" >
                {buttonClick[0]?(<ButtonContain size="medium" text="결재 내역" handleClick={handleClickPaymentDetail}/>):(<ButtonOutlined size="medium" text="결재 내역" handleClick={handleClickPaymentDetail}/>)}
            </Link>
        </Grid>
        <Grid item xs={0.9}>
            <Link to="/mypage/paymentDetail/checkReview">
                {buttonClick[1]?(<ButtonContain size="medium" text="리뷰 조회" handleClick={handleClickReview}/>):(<ButtonOutlined size="medium" text="리뷰 조회" handleClick={handleClickReview}/>)}
            </Link>
        </Grid>
        <Grid item xs={0.9}>
            <Link to="/mypage/paymentDetail/registerReview">
                {buttonClick[2]?(<ButtonContain size="medium" text="리뷰 작성" handleClick={handleClickReviewWrite}/>):(<ButtonOutlined size="medium" text="리뷰 작성" handleClick={handleClickReviewWrite}/>)}
            </Link>
        </Grid>
