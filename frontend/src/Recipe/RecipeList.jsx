...
const ViewList = () => {
    ...
    const clickBookmark = (e, recipeNo) => {
        if(accessToken===''){
            ...
            axios.post(`${url}/api/recipes/like/${recipeNo}`,{
                headers:{
                    Authorization : accessToken
                }
            })
        ...
        <div className="viewList-Box">
            <div className="sortList">
                ...
                <div className="sortList-right">
                    <ButtonOutlinedStyle className="view-register" variant="outlined" onClick={clickRegister}> 레시피 등록 </ButtonOutlinedStyle>
                </div>
            </div>
            <div className="viewList">
                ...
                {listData.length !== 0 && listData.map((data, index) =>
                    <div style={{ position: 'relative' }}>
                        <Bookmark check={data.recipeLikeStatus} sx={{ cursor: 'point' }} onClick={(e) => clickBookmark(e, data.recipeNo)} />
